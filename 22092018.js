...
// console.log("TG cong tac: "+ gv.tg_cong_tac(1997)+"nam");


class Sach{
	constructor(ten_sach,gia,tac_gia){
		this.ts = ten_sach;
		this.g = gia;
		this.tg = tac_gia;
	}
	in_sach(){
		console.log("Ten Sach: "+ this.ts);
		console.log("Gia: "+ this.g);
		console.log("Tac gia: " + this.tg);
	}

	get_sach(){
		var rs = "Ten Sach : "+ this.ts + " Gia: "+ this.ts +" Tac gia: "+ this.tg;
		return rs;
	}
}


var sach = new Sach("A",25000,"NG Van A");
sach.in_sach();
console.log("Sach hien tai la: " + sach.get_sach());
console.log(sach);